export const FACTIONS = {
    ...
    VAULT: { id: 'vault', name: 'Guardiões do Cofre' },
...
const FRIENDLY_GROUPS = {
    ...
    guard: ['plant', 'player', 'village', 'guard', 'animal_friendly', 'animal_prey', 'hunter', 'vault'],
    vault: ['vault', 'guard', 'player'],
    ...
    mutant_beast: ['mutant_beast', 'beast', 'animal_predator'],
    hunter: ['hunter', 'guard', 'village', 'player'],
    aquatic: ['aquatic'],
    undead: ['undead', 'demon', 'abyss', 'infested_plant'],
    panlord: ['panlord', 'demon', 'abyss'],
